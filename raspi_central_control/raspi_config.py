...
LED_STRIP_COUNT = 336    # Total number of LEDs yang FISIKNYA SUDAH TERPASANG (315 + 21 pressurizer)
...
LED_SEGMENT_PRESSURIZER = (315, 21)   # Pipa Pressurizer (disambung dari keluaran primer)
