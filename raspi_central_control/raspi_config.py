...
LED_STRIP_COUNT = 743    # Total number of LEDs (724 + 19)
...
LED_SEGMENT_TERSIER_OUT = (701, 23)   # Keluaran kondenser ke cooling tower (Merah)
LED_SEGMENT_SEKUNDER_IN = (724, 19)   # Baru: Aliran sekunder dari kondenser (Biru)
