...
LED_STRIP_COUNT = 358    # Total number of LEDs yang FISIKNYA SUDAH TERPASANG (334 + 24 sekunder_in tambahan)
...
LED_SEGMENT_SEKUNDER_IN = (151, 69)   # Baru: Gabungan aliran sekunder dari kondenser (sebelumnya 45 + 24 = 69)
LED_SEGMENT_PRIMER      = (220, 117)  # Pipa Primer (disambung dari keluaran sekunder)
LED_SEGMENT_PRESSURIZER = (337, 21)   # Pipa Pressurizer (disambung dari keluaran primer)
