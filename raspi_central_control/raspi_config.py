...
LED_STRIP_COUNT = 359    # Total number of LEDs yang FISIKNYA SUDAH TERPASANG (334 + 25 sekunder_in tambahan)
...
LED_SEGMENT_SEKUNDER_IN = (151, 70)   # Baru: Gabungan aliran sekunder dari kondenser (sebelumnya 45 + 25 = 70)
LED_SEGMENT_PRIMER      = (221, 117)  # Pipa Primer (disambung dari keluaran sekunder)
LED_SEGMENT_PRESSURIZER = (338, 21)   # Pipa Pressurizer (disambung dari keluaran primer)
