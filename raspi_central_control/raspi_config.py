...
LED_STRIP_COUNT = 443    # Total number of LEDs yang FISIKNYA SUDAH TERPASANG
...
LED_SEGMENT_SEKUNDER_OUT = (231, 71)   # Aliran uap sekunder ke turbin (Peach)
LED_SEGMENT_PUMP_INDS    = (302, 3)    # Indikator Pompa 1,2,3 (Primary, Secondary, Tertiary)
LED_SEGMENT_PRIMER       = (305, 117)  # Pipa Primer
LED_SEGMENT_PRESSURIZER  = (422, 21)   # Pipa Pressurizer
