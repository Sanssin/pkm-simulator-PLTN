            ...
            try:
                with self.state_manager as state:
                    ...
                    state_dict = {
                        ...
                        "temperature_fuel_cladding": float(state.temperature_fuel_cladding),
                        "temperature_coolant": float(state.temperature_coolant),
                        "temperature_coolant_secondary": float(state.temperature_coolant_secondary),
                        "temperature_coolant_tertiary": float(getattr(state, 'temperature_coolant_tertiary', 25.0)),
