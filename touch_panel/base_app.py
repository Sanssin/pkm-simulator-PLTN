...
class TouchPanelBaseWindow(QMainWindow):
    ...
    def _build_status_dashboard(self) -> QWidget:
        ...
        rod_layout.addWidget(QLabel("Kompensasi (Shim)"))
        rod_layout.addWidget(self.bar_shim)
        rod_layout.addWidget(QLabel("Pengatur (Regulating)"))
    ...
    def _build_control_column(self) -> QVBoxLayout:
        ...
        lbl_saf = QLabel("Batang Pengaman (SAFETY):")
        ...
        lbl_shim = QLabel("Batang Kompensasi (SHIM):")
        ...
        lbl_reg = QLabel("Batang Pengatur (REGULATING):")
    ...
    def _run_local_simulation_step(self) -> None:
        ...
        if self.sim_auto_running:
            ...
            if effective_rod > 0.0:
                ...
                if self.sim_fuel_cladding_temp > 345.0:
                    excess_temp = self.sim_fuel_cladding_temp - 345.0
                    self.sim_pressure += (excess_temp * 1.5)
